  ...
  return (
    <footer id="contact" className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-28">
          <h2 className="text-[clamp(60px,10vw,140px)] leading-[0.85] font-bold tracking-tight text-foreground">
            LET’S BUILD <br />
            <span className="text-muted-foreground/30">SYSTEMS</span>
          </h2>
        ...
        <motion.div
          ...
          className="backdrop-blur-xl bg-card border border-border p-12 rounded-3xl shadow-sm"
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col gap-10">
              ...
              <a
                ...
                className="group flex items-center gap-4 text-[clamp(16px,5vw,36px)] md:text-4xl font-semibold text-foreground hover:text-muted-foreground transition whitespace-nowrap"
              >
              ...
              <div className="flex flex-wrap gap-8 pt-8 border-t border-border">
                <a
                  ...
                  className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition uppercase tracking-wider text-sm"
                >
