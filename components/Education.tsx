    ...
    <section className="py-32 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="backdrop-blur-xl bg-card border border-border p-14 rounded-2xl shadow-sm"
        >
          {/* University Info */}
          ...
          <div className="grid md:grid-cols-3 gap-8 text-muted-foreground text-sm">
